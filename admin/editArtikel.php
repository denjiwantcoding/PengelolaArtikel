...
$id = intval($_GET['id']);
$sql = "SELECT a.id, a.title, a.content, a.picture, ac.category_id 
    FROM article a 
...
if (isset($_POST['update'])) {
    ...
    echo "<script>alert('Artikel berhasil diupdate!');window.location='article.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
                ...
                <div class="card-body">
                    <form action="editArtikel.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <a href="article.php" class="btn btn-secondary w-100 mt-2">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
