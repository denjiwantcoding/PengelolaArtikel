...
// Query jumlah data
$jumlah_article = $koneksi->query("SELECT COUNT(*) as total FROM article")->fetch_assoc()['total'];
$jumlah_author = $koneksi->query("SELECT COUNT(*) as total FROM author")->fetch_assoc()['total'];
$jumlah_category = $koneksi->query("SELECT COUNT(*) as total FROM category")->fetch_assoc()['total'];
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Article</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_article; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Author</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_author; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Category</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_category; ?></div>
                                        </div>
                                        <div class="col-auto">
