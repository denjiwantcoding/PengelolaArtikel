...
<body id="page-top">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-warning btn-sm edit-btn"
                                                            data-id="<?= $kat['id']; ?>"
                                                            data-name="<?= htmlspecialchars($kat['name'], ENT_QUOTES); ?>"
                                                            data-toggle="modal" data-target="#modalEditKategori">
                                                            Edit
                                                        </button>
                                                        <a href="delete_category.php?id=<?= $kat['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
    ...
    <div class="modal-dialog" role="document">
        <form action="tambah_category.php" method="POST" class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama-kategori" name="name" required>
                </div>
                <div class="form-group">
                    <label for="deskripsi-kategori">Deskripsi</label>
                    <textarea class="form-control" id="deskripsi-kategori" name="description" rows="3"></textarea>
                </div>
            </div>
        ...
        <form action="edit_category.php" method="POST" class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="edit-nama-kategori" name="name" required>
                </div>
                <div class="form-group">
                    <label for="edit-deskripsi-kategori">Deskripsi</label>
                    <textarea class="form-control" id="edit-deskripsi-kategori" name="description" rows="3"></textarea>
                </div>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    $('#edit-nama-kategori').val($(this).data('name'));
    $('#edit-deskripsi-kategori').val($(this).closest('tr').find('td:nth-child(3)').text().trim());
});
</script>
</body>
